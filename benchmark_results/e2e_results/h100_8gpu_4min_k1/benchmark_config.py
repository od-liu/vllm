...
/mnt/disk1/ljm/qwen/bin/python -u benchmarks/benchmark_e2e_metrics.py --config /tmp/e2e_temp_config_tp2_pp1_dp4.py --phase 1
"""
...
config = BenchmarkConfig(
    ...
    output_file="e2e_results/h100_8gpu_4min_k1/tp2_pp1_dp4_e2e.json",
